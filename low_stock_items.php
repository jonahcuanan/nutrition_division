        ...
        if (empty($editErrors)) {
            ...
            if ($stmt) {
                ...
                if ($stmt->execute()) {
                    ...
                    header('Location: low_stock_items.php');
                    exit;
                }
        ...
        if (empty($restockErrors)) {
            ...
            if ($stmt) {
                ...
                if ($stmt->execute()) {
                    ...
                    header('Location: low_stock_items.php?restocked=1');
                    exit;
                }
...
$invResult = $conn->query("SELECT {$invSelect} FROM inventory i LEFT JOIN category_inventory c ON i.category_id = c.category_id WHERE i.quantity <= 5 ORDER BY i.item_name");
...
<main class="main-content">
    <div class="page-header">
        ...
        <div class="page-header-text">
            <h1>Low Stock Items Overview</h1>
            <p>Monitor and restock items with 5 or fewer units left</p>
        </div>
        ...
        <div class="card-header">
            <div class="card-header-left">
                ...
                <div>
                    ...
                    <p>Displaying inventory items currently low in stock</p>
                </div>
            </div>
        </div>
        <div class="toolbar">
        ...
        <table class="table-stack">
            ...
            <?php if (!empty($inventoryItems)):
                foreach ($inventoryItems as $row):
                    ...
                    else                { $qtyClass = 'qty-warn';  $availability = 'in'; }
